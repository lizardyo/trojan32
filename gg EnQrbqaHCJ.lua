...
local Window = library:AddWindow("lizard lock", {
...
CreditTAB:AddButton("Made by lizard", function(bool)
    setclipboard("lizard")
    wait(1)
    local function callback(text)
        if text == "Yes" then
...
ESPTab:AddSwitch("turn this on for esp to work", function(bool)
    ESP:Toggle(bool)
end)
...
ESPTab:AddSwitch("Names", function(bool)
    ESP.Names = bool
end)
...
ALTab:AddSwitch("Silent", function(bool)
    DaHoodSettings.SilentAim = bool
end)
 
ALTab:AddSwitch("hard lock", function(bool)
    DaHoodSettings.AimLock = bool
end)
 
ALTab:AddSwitch("deving", function(bool)
...
ALTab:AddSwitch("use if lag", function(bool)
...
pcall(function()
    game.StarterGui:SetCore("SendNotification", {
      ...
      Text = 'Join our discord, https://discord.gg/lizardcc';
      Duration = 40;
    })
    if not game.Players.LocalPlayer:IsInGroup(13635825) then
      coroutine.resume(coroutine.create(function()
         ...
         setclipboard('https://discord.gg/lizardcc')
      end))
    end
  end)